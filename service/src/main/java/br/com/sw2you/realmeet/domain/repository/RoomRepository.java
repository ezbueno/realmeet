...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(value = "UPDATE Room r SET r.active = false WHERE r.id = :roomId")
    void deactivate(@Param(value = "roomId") Long roomId);

    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query(value = "UPDATE Room r SET r.name = :name, r.seats = :seats WHERE r.id = :roomId")
    void updateRoom(
